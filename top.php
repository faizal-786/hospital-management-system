...
$meta_title="Hospital Management System";
$meta_desc="Hospital Management System";
$meta_keyword="Hospital Management System";
...
<body>
    ...
    <div class="wrapper">
        <header id="htc__header" class="mynavcolor htc__header__area header--one navcss">
            <div id="sticky-header-with-topbar" class="mainmenu__wrap sticky__header">
                <div class="container">
                    <div class="row">
                        <div class="menumenu__container clearfix background-color: #ecafc3;">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
							   <div class="logo">
							       <h2 class="logocss1">!</h2>
							       <a href="index.php"><h2 class="logocss">hms</a>
							   </div>
							</div>
							<!--<div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                            ...
                            <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="header__account mx-0">
										<?php if(isset($_SESSION['USER_LOGIN'])){
											?>
													...
													<div class="dropdown-menu" aria-labelledby="navbarDropdown">
													  ...
													  <div class="dropdown-divider"></div>
													  <a class="dropdown-item" href="downline.php">Downline</a>
													  <div class="dropdown-divider"></div>
									...
									<div class="htc__wallet">
										...
										<?php } ?>
                                        <a href="payment.php"><i class="fas fa-coins"></i></a>
