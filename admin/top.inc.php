         ...
         <header id="header" class="header">
            ...
            <div class="top-right">
               <div class="header-menu">
				  ...
				  <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Balance <?php echo $wallet_admin; ?></a>
                     <div class="user-menu dropdown-menu">
                        <a class="nav-link" href="payment.php"><i class="fa fa-coins"></i>Wallet</a>
                     </div>
                  </div>
