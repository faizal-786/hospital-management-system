...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			$update_sql="update admin_users set username='$username',password='$password',email='$email',mobile='$mobile',wallet='$wallet' where id='$id'";
                     ...
                     <div class="card">
                        ...
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Wallet</label>
									<input type="text" name="wallet" placeholder="Enter wallet balance" class="form-control" required value="<?php echo $wallet?>">
								</div>
