...
<!-- Start Bradcaump area -->
		...
		<!-- Start Contact Area -->
        <section class="bgwhite htc__contact__area ptb--100 bg__white">
            <div class="container">
                <div class="row">
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<br>
									<h5 class="title__line--6">Refer Code</h5> 
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="referral_code" id="referral_code" placeholder="Your Name*" style="width:100%" value="<?php echo $_SESSION['USER_REFERRAL_CODE']?>">
										</div>
										<span class="field_error" id="name_error"></span>
									</div>
									<h5 class="title__line--6">Refer Link</h5>
									<p><?php echo SITE_PATH?>login.php?referral_code=<?php echo $_SESSION['USER_REFERRAL_CODE']?></p>
									</br>
